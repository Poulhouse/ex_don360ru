...
<html style="font-size: 16px;">
  <head>
    ...
    <title>Виртуальная экскурсия по Раздорскому этнографическому музею-заповеднику</title>
		...
		<link href="<?echo '//'.$_SERVER['SERVER_NAME']. '/uznay-rossiyu/assets/css/style.css?v=1.2.0';?>" rel='stylesheet' type='text/css'>
			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				<div class="container header_wrapper">
					<div class="col-auto me-auto">
						<?php if($_GET['lang'] == 'ru' || $_GET['lang'] != 'en' || $_GET['lang'] != 'ch' || $_GET['lang'] != 'ru'){ ?>
				...
				<div class="row align-items-center">
					...
					<div class="col-12 col-xxl-8 col-xl-7 col-lg-12 col-md-12">
						<div class="desc">
							...
							<p class="default_text">Благодарим за совместную работу Раздорский этнографический музей-заповедник (<a href="http://museum-razdory.ru/" target="_blank">http://museum-razdory.ru/</a>)и дочь писателя А.В. Калинина Наталью Анатольевну Калинину.</p>
