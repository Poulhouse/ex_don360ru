...
<html style="font-size: 16px;">
  <head>
	...
	<?} elseif($_GET['lang'] == 'en'){?>
		...
		<title>Virtual tour of Pushkinskaya street in Rostov-on-Don</title>
		
	<?} elseif($_GET['lang'] == 'ch'){?>
	
		<title>顿河畔罗斯托夫普希金大街的虚拟之旅</title>
	...
	<?} elseif($_GET['lang'] == 'en'){?>
		...
		<meta property="og:title" content="Virtual tour of Pushkinskaya street in Rostov-on-Don">
		
	<?} elseif($_GET['lang'] == 'ch'){?>
	
		<meta property="og:title" content="顿河畔罗斯托夫普希金大街的虚拟之旅">
		...
		<div class="container">
			<div class="row align-items-center justify-content-center">
				...
				<?php if($_GET['lang'] == 'ru' || $_GET['lang'] == ''){ ?>
					...
					<h1>Виртуальный тур по улице Пушкинской в Ростове-на-Дону</h1><p class="small_text">Экскурсия в сопровождении аудиогида</p>
					
				<?} elseif($_GET['lang'] == 'en'){?>
				
					<h1>Virtual tour of Pushkinskaya street in Rostov-on-Don</h1><p class="small_text">Guided by virtual tour</p>
					
				<?} elseif($_GET['lang'] == 'ch'){?>
				
					<h1>顿河畔罗斯托夫普希金大街的虚拟之旅</h1><p class="small_text">带语音导览的导览游</p>
