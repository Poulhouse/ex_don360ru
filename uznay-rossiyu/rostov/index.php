...
<html style="font-size: 16px;">
  <head>
    ...
    <title>Виртуальный тур по улице Пушкинской в Ростове-на-Дону</title>
...
@media all and (max-width:920px) {
    ...
    <script type="application/ld+json">{
		...
		"@type": "Organization",
		"name": "",
		"url": "https://fiveday.ru/tour_new/rostov/"
}</script>
 ...
 <body class="body " style="">
	...
	<div id="centerLayer">
		...
		<img src="../assets/images/pushkin.jpg" width="500" style="position: absolute;width: auto;height: calc(100vh - 200px); 
    right: 0;">	 
	</div>
					...
					<div class="full-width">
						<div class="w-actionbox color_primary controls_aside">
							<div class="w-actionbox-h">
								<div class="w-actionbox-text"><h1>Виртуальный тур по улице Пушкинской в Ростове-на-Дону</h1><p>Экскурсия по улице Пушкинской в сопровождении аудиогида</p></div>
